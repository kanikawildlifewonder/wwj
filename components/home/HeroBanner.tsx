...
export function HeroBanner({
  ...
  return (
    <section className="relative w-full h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-jungle">
      ...
      {/* Content */}
      <div className="container relative z-10 mx-auto px-4 lg:px-8 flex flex-col items-start pt-20">
        <motion.div
      ...
      <motion.div 
        ...
        className="absolute bottom-8 right-8 z-10 hidden md:flex items-center justify-center w-36 h-36 rounded-full border border-gold/30 bg-jungle/60 backdrop-blur-sm p-4 text-center"
      >
