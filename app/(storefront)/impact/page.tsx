    ...
    <div className="bg-cream min-h-screen">
      ...
      <section className="relative h-[40vh] sm:h-[45vh] md:h-[50vh] min-h-[300px] sm:min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-ivory mb-4 sm:mb-6 tracking-wide">
            Conservation First
          </h1>
      ...
      {/* Impact Pillars */}
      <section className="py-12 sm:py-20 bg-jungle text-ivory">
      ...
      {/* Partners */}
      <section className="py-16 sm:py-24 text-center px-4 bg-ivory">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-12 opacity-50 grayscale">
          {/* Mock Logos */}
          <div className="font-display text-lg sm:text-2xl font-bold tracking-widest">WILDTRUST</div>
          <div className="font-display text-lg sm:text-2xl font-bold tracking-widest">SAVETHECATS</div>
          <div className="font-display text-lg sm:text-2xl font-bold tracking-widest">EARTHFUND</div>
          <div className="font-display text-lg sm:text-2xl font-bold tracking-widest">GREENHORIZON</div>
        </div>
