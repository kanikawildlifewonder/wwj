...
export default function AboutPage() {
  return (
    <div className="bg-jungle min-h-screen flex flex-col justify-between">
      {/* Header section */}
      <div className="py-12 sm:py-20 text-center px-4 max-w-3xl mx-auto shrink-0">
        <div className="flex items-center justify-center gap-3 mb-4">
          <span className="w-10 h-px bg-gold/45" />
      ...
      {/* Split Cards Grid */}
      <div className="container mx-auto px-4 lg:px-8 mb-16 sm:mb-24 grow grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        
        {/* Card 1: Our Brand Story */}
        <div className="group relative rounded-2xl overflow-hidden border border-border bg-forest h-100 sm:h-112.5 md:h-125 flex flex-col justify-between shadow-xl">
